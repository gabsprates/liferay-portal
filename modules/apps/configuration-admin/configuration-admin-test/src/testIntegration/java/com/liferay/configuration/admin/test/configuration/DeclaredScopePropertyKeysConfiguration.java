 ...
 * so the value is business data and must not be read as a scope marker.
 *
 * @author Gabriel Prates
 */
@Meta.OCD(
	id = "com.liferay.configuration.admin.test.configuration.DeclaredScopePropertyKeysConfiguration"
)
