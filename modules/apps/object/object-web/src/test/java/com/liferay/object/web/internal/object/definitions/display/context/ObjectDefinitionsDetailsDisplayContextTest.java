...
public class ObjectDefinitionsDetailsDisplayContextTest {
	...
	public void setUp() {
		...
		_registerPanelCategory(
			bundleContext, _OTHER_PANEL_CATEGORY_KEY, _ROOT_PANEL_CATEGORY_KEY,
			200);
		_registerPanelCategory(
			bundleContext, _EMPTY_ROOT_PANEL_CATEGORY_KEY, null, 0);
		...
		Mockito.when(
			...
			new String[] {
				_ROOT_PANEL_CATEGORY_KEY, _EMPTY_ROOT_PANEL_CATEGORY_KEY
			}
		);
